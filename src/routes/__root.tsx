...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Ask BIET is the AI assistant for Bapuji Institute of Engineering & Technology. Instant answers on admissions, courses, placements, fees and more." },
